...
const TAG = {
		REQUEST: `${process.env.APP_NAME}-request`,
		RESPONSE: `${process.env.APP_NAME}-response`,
		DEBUG: `${process.env.APP_NAME}-debug`,
		ERROR: `${process.env.APP_NAME}-error`,
...
var initialize = _.once(function(){
	...
	logger = bunyan.createLogger({
		name: `${process.env.APP_NAME} Server Log`,
		streams: streams,
		serializers: {
