...
userRouter.route('/update').post([userMiddleware.authenticateAccesstoken],controller.updateUser)
...
userRouter.route('/details/:id').get([userMiddleware.authenticateAdminAccesstoken],controller.userDetailsAdmin)
